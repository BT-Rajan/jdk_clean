...
export function ProfilePage() {
  ...
  // Department users' /dashboard is their department overview, which has
  // no widgets to customize -- the customizer only applies to the generic
  // dashboard (see pages/DashboardRoute.tsx).
  const hasCustomDashboard = getDepartmentHomePath(user, permissions) === null
