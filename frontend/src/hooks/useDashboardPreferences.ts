...
const availableWidgetsByRole: Record<string, DashboardWidget[]> = {
  sales: [
    ...
    { id: 'order-position', title: 'Order Position', type: 'graph', dataSource: 'order_position', enabled: true },
  ...
  inventory: [
    ...
    { id: 'inventory-breakdown', title: 'Inventory Breakdown', type: 'graph', dataSource: 'inventory_breakdown', enabled: true },
  ],
  production: [
    { id: 'production-orders', title: 'Active Productions', type: 'stats', dataSource: 'production_active', enabled: true },
    { id: 'production-this-month', title: 'Produced This Month', type: 'stats', dataSource: 'production_this_month', enabled: true },
    { id: 'production-capacity', title: 'Capacity Utilization (MTD)', type: 'stats', dataSource: 'production_capacity_utilization', enabled: true },
  ...
  admin: [
    ...
    { id: 'admin-low-stock', title: 'Low Stock Items', type: 'stats', dataSource: 'low_stock_count', enabled: true },
    { id: 'admin-production-this-month', title: 'Produced This Month', type: 'stats', dataSource: 'production_this_month', enabled: true },
    { id: 'admin-production-capacity', title: 'Capacity Utilization (MTD)', type: 'stats', dataSource: 'production_capacity_utilization', enabled: true },
    { id: 'admin-order-position', title: 'Order Position', type: 'graph', dataSource: 'order_position', enabled: true },
