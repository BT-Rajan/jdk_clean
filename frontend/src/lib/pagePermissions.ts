 ...
 * regardless of this matrix (see PagePermissionGuard). /users no longer
 * has its own sidebar entry -- it's reached from Settings -> Factory
 * setup now -- but the route/permission itself is unchanged.
 */
